...
def initial_pos_pub():
    ...
    start_pos.pose.pose.position.x = 0.792
    start_pos.pose.pose.position.y = -0.377
    start_pos.pose.pose.position.z = 0.0

    start_pos.pose.pose.orientation.x = 0.0
    start_pos.pose.pose.orientation.y = 0.0
    start_pos.pose.pose.orientation.z = -0.847
    start_pos.pose.pose.orientation.w = 0.531
