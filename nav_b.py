...
class NavTest():
    def __init__(self):
        ...
        locations['1'] = Pose(Point(-2.07, -0.46, 0.000),
                              Quaternion(0.000, 0.000, -0.724, 0.69))

        locations['2'] = Pose(Point(-2.22, -1.20, 0.000),
                              Quaternion(0.000, 0.000, -0.036, 0.999))

        locations['3'] = Pose(Point(-0.425, 0.145, 0.000),
                              Quaternion(0.000, 0.000, -0.721, 0.69))
