...
class NavTest():
    def __init__(self):
        ...
        locations['north_east'] = Pose(Point(5.139, -0.816, 0.000),
                                  Quaternion(0.000, 0.000, -0.309, 0.951))
        locations['south_west'] = Pose(Point(0.0787, 0.204, 0.000),
                                    Quaternion(0.000, 0.000, -0.816, 0.578))
        locations['south_east'] = Pose(Point(0.087, -1.568, 0.000),
                                    Quaternion(0.000, 0.000, -0.003, 1.000))
 
        locations['north_east'] = Pose(Point(4.4076, 0.815, 0.000),
